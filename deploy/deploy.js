...
module.exports = async () => {
  ...
  console.log("SupertrueNFT deployed:", supertrueNFTContract.address);
  ...
  let functionCall = diamondInit.interface.encodeFunctionData('init', [supertrueNFTContract.address])
